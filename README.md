# Available .CHANNEL One-Word Domains (10,427)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-10%2C427%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **10,427 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 10,427 domains · **Median ask:** $106.62 · **High-demand under $2,500:** 0
...
| Friends.channel     | premium   | $698.60   | $698.60       | 82             | 41     | 7      | namecheap |
| snaps.channel       | available | $16.48    | —             | 52             | 20     | 5      | namecheap |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 10,427 live domains                        |
...
These domains are all in the .channel extension, which makes the main decision less about TLD choice and more about the name itself. In this set, the median ask is 106.62, so buyers should focus on whether a domain is clean, memorable, and commercially usable at that price level. Short, generic terms such as finals.channel may feel more flexible than coined or awkward strings such as xoxoxo.channel. Sample names like Skype.channel, Adidas.channel, Reebok.channel, and Fanta.channel also show why trademark screening matters here. When comparing these domains, weigh clarity, resale practicality, renewal tolerance, and legal risk before treating any low ask as attractive.

- All results use the .channel extension
- Median ask across this selection is 106.62
- Generic terms usually age better than branded strings
...
> Unique Domains. *Available .CHANNEL One-Word Domains*. Version 2026-05-27. Public GitHub extract for the exact Unique Domains search represented by this repository.
